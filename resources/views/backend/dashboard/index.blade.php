                                ...
                                <ul class="dropdown_menu dropdown_menu-7" id="dropdown-desktop">
                                    <li>
                                        <a href="{{ url('admin/submissions') }}"
                                            class="nav-pill @yield('submission_active')">
                                    ...
                                    <li>
                                        <a href="{{ route('borrows.overdue') }}"
                                            class="nav-pill @yield('overdue_active')">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <div class="rounded-3 d-flex align-items-center justify-content-center"
                            ...
                            <img src="{{ $imageSocket?->image ? Storage::url($imageSocket->image) : '' }}" alt="socket"
                                width="54" height="54"
                ...
                <div class="card-body px-4">
                    ...
                    <div class="d-flex align-items-start gap-3 py-3 border-bottom">
                        <div>
                            ...
                            <img src="{{ Storage::url($borrow->item->image) }}" width="54" height="54"
